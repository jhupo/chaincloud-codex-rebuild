...
function patchAgentSettingsBundle(platform, isCheck) {
  ...
  if (
    ...
    !source.includes("await " + requestFn + "(`login-with-api-key`,{hostId:ccHostId,apiKey:t[0].key}") &&
