...
function patchComposerBundles(platform, isCheck) {
  ...
  for (const name of fs.readdirSync(assetsDir)) {
    ...
    if (source.includes("function SF(e)") && !source.includes("ChainCloudInlineBilling")) {
      ...
      source = source.replace("function SF(e)", helper + "function SF(e)");
      const tooltipNeedle = "children:[b,C,E,D]";
      if (source.includes(tooltipNeedle)) {
        source = source.replace(tooltipNeedle, "children:[b,C,E,D,(0,Q.jsx)(ChainCloudInlineBilling,{})]");
        changed = true;
      }
    }
    if (changed) {
